          ...
          html: `
            <div style="font-family:monospace;background:#1A3F78;color:#A8D8FF;padding:32px;border-radius:6px;max-width:600px">
              ...
              <table style="width:100%;border-collapse:collapse;font-size:13px">
                <tr><td style="color:#5B9BD5;padding:6px 0;width:120px">DE :</td><td style="color:#fff">${name}</td></tr>
                <tr><td style="color:#5B9BD5;padding:6px 0">REPLY-TO :</td><td><a href="mailto:${email}" style="color:#00C8BE">${email}</a></td></tr>
                <tr><td style="color:#5B9BD5;padding:6px 0">OBJET :</td><td style="color:#FFE033">${subject}</td></tr>
              </table>
